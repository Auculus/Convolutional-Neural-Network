...
public abstract class Layer {
    ...
    public abstract double[] getOutput(List<double[][]> input); // Matrix list input
    public abstract double[] getOutput(double[] input); // Vector input
    ...
    public double[] matrixToVector(List<double[][]> input){
        ...
        double[] vector = new double[length*cols*rows];
        int i = 0;
